...
project, the note, draft, deep-search and pdf-read skills under `skills/`, and
the decisions in `docs/adr/`. How to work with the Vault is in `global.md` and
in the skills; this file is only about changing them.
